        ...
        <>
            {
                (question == null) ? "Loading" :
                    <Card className='question-container w-max min-w-[75%] m-auto mt-[20vh]'>
                        <CardHeader className="question">{question.question}</CardHeader>
                        <CardContent>
                            ...
                            {
                                submitted ?
                                    <Button onClick={fetchQuestion} className="mt-5">Next Question</Button> :
                                    <Button onClick={checkAnswer} className="mt-5">Submit</Button>
                            }
                        </CardContent>
                    </Card>
            }
